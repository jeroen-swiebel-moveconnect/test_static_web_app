...
export const environment = {
    ...
    UI_ROOT: 'https://mw10-test.moveconnect.com',
    FRAMEWORK_COMMAND_ROOT: 'https://mw10.moveconnect.com/api/test',
    FRAMEWORK_QUERY_ROOT: 'https://mw10.moveconnect.com/api/test',
