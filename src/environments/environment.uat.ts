...
export const environment = {
    ...
    UI_ROOT: 'https://mw10-uat.moveconnect.com',
    FRAMEWORK_COMMAND_ROOT: 'https://mw10.moveconnect.com/api/uat',
    FRAMEWORK_QUERY_ROOT: 'https://mw10.moveconnect.com/api/uat',
